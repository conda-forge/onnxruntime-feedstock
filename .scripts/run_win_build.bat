...
mamba.exe install "python=3.10" pip mamba conda-build conda-libmamba-solver conda-forge-ci-setup=4 "conda-build>=24.1" -c conda-forge --strict-channel-priority --yes
if !errorlevel! neq 0 exit /b !errorlevel!
